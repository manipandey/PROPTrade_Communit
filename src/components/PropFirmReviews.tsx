...
import { Star, ShieldCheck, Check, X, HelpCircle, Landmark, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 space-y-12">
                  ...
                  <tr
                    ...
                    className={`cursor-pointer transition-all ${
                      selectedFirmId === firm.id 
                        ? 'bg-brand-green/5 text-white font-bold' 
                        : 'hover:bg-zinc-950/30 text-zinc-400'
                    }`}
                  >
      ...
      <div className="rounded-xl border border-brand-green/20 bg-brand-green/5 p-4 flex gap-3 text-xs leading-relaxed max-w-4xl mx-auto">
        ...
        <div className="space-y-1 text-left">
          <span className="font-bold text-white uppercase tracking-wider text-[10px]">Nepal Payout Tips:</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start max-w-5xl mx-auto">
        {/* Core details column */}
        <div className="md:col-span-6 rounded-xl border border-zinc-800 bg-[#0c0c0e] p-6 space-y-4 glow-accent">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-black text-white">{activeFirm.name} Performance Overview</h3>
          ...
          <div className="space-y-3.5 text-xs text-zinc-400">
            <div className="flex justify-between py-2 border-b border-zinc-900">
              <span className="font-semibold text-zinc-500">Daily Drawdown Cap</span>
              <span className="font-mono text-white font-bold">{activeFirm.dailyDrawdown}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-zinc-900">
              <span className="font-semibold text-zinc-500">Maximum Allowed Drawdown</span>
              <span className="font-mono text-white font-bold">{activeFirm.maxDrawdown}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-zinc-900">
              <span className="font-semibold text-zinc-500">Profit Challenge Targets</span>
              <span className="font-mono text-white font-bold">{activeFirm.profitTarget}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-zinc-900">
              <span className="font-semibold text-zinc-500">Fee Refund Policy</span>
              <span className="text-zinc-300 font-bold">{activeFirm.refundFee}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-zinc-900">
              <span className="font-semibold text-zinc-500">Nepal Wallet Integrations</span>
        ...
        <div className="md:col-span-6 space-y-6">
          {/* Pros */}
          <div className="rounded-xl border border-zinc-900 bg-[#070708] p-5 space-y-3">
